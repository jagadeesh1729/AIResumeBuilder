  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-[#3FA9F520] text-[var(--brand-primary)] rounded-lg hover:bg-[#3FA9F533] transition-colors'>
