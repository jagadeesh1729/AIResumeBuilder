        ...
        <div className="max-w-5xl mx-auto bg-white text-zinc-800 text-sm font-sans">
            <div className="grid grid-cols-12">
                ...
                <aside className="col-span-4 border-r border-zinc-200 p-6">
                    ...
                    {sections?.filter(section => ['education', 'skills', 'certifications'].includes(section.id)).map(section => sectionComponents[section.id])}
                </aside>
                {/* Right Content */}
                <main className="col-span-8 p-6">
                    ...
                    {sections?.filter(section => ['summary', 'experience', 'projects'].includes(section.id)).map(section => sectionComponents[section.id])}
                </main>
            </div>
        </div>
    );
