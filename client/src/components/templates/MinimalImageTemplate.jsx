        ...
        <div className="max-w-5xl mx-auto bg-white text-zinc-800">
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-2 flex flex-col justify-center py-10 px-8">
                    ...
                    {/* Removed profession to keep header to 2 lines (name + contact) */}
                    <div className="mt-2">
                      <HeaderContact personal={data.personal_info} className="text-sm text-zinc-600" />
                    </div>
                </div>
                    ...
                    <section className="mb-8">
                        ...
                        <div className="space-y-2 text-sm">
                            {data.personal_info?.phone && (
                                <a href={`tel:${data.personal_info.phone}`} className="flex items-center gap-2" style={{ color: 'blue', textDecoration: 'underline' }}>
                                    <Phone size={14} style={{ color: accentColor }} />
                                    <span>{data.personal_info.phone}</span>
                                </a>
                            )}
                            {data.personal_info?.email && (
                                <a href={`mailto:${data.personal_info.email}`} className="flex items-center gap-2" style={{ color: 'blue', textDecoration: 'underline' }}>
