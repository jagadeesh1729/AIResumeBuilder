...
const ClassicTemplate = ({ data, accentColor, sections }) => {
    ...
    const sectionComponents = {
        summary: (
            <section key="summary" className="mb-5 break-inside-avoid">
        ...
        experience: (
            <section key="experience" className="mb-5 break-inside-avoid">
        ...
        projects: (
            <section key="projects" className="mb-5 break-inside-avoid">
                <h2 className="text-lg sm:text-xl font-semibold mb-3" style={{ color: accentColor }}>
                    PROJECTS
                </h2>
                <div className="space-y-4">
        ...
        certifications: (
            <section key="certifications" className="mb-5 break-inside-avoid">
                <h2 className="text-lg sm:text-xl font-semibold mb-3" style={{ color: accentColor }}>
                    CERTIFICATIONS
                </h2>
        ...
        education: (
            <section key="education" className="mb-5 break-inside-avoid">
                <h2 className="text-lg sm:text-xl font-semibold mb-3" style={{ color: accentColor }}>
                    EDUCATION
                </h2>
                <div className="space-y-3">
        ...
        skills: (
            <section key="skills" className="mb-5 break-inside-avoid">
                <h2 className="text-lg sm:text-xl font-semibold mb-3" style={{ color: accentColor }}>
                    CORE SKILLS
                </h2>
