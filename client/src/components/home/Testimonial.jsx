...
const Testimonial = () => {
            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" style={{ fill: 'var(--brand-primary)' }}>
  ...
  return (
    ...
    <div className="flex items-center gap-2 text-sm text-[var(--brand-primary)] bg-[#3FA9F51A] rounded-full px-6 py-1.5">
        <BookUserIcon className="size-4.5" style={{ stroke: 'var(--brand-primary)' }}/>
